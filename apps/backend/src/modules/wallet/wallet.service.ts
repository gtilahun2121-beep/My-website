...
export class WalletService {
    ...
    /**
     * Public PIN verification used by POST /api/v1/wallets/verify-pin.
     * Returns a boolean so the caller can drive the withdrawal UI flow.
     */
     ...
     */
    private async assertValidPin(userId: string, pin: string, ctx: RlsContext) {
