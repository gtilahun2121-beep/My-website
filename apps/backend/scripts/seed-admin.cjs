 ...
 * seed-admin.cjs
 *
 * Seeds (or resets) a real admin user in the Neon database.
 ...
 *   ADMIN_SEED_EMAIL  admin@qalnet.com
 *   ADMIN_SEED_PHONE  +251911000000
 *   ADMIN_SEED_PIN    1234            (raw 4-digit PIN; padded internally)
 */
...
const ADMIN_EMAIL = process.env.ADMIN_SEED_EMAIL || 'admin@qalnet.com';
const ADMIN_PHONE = process.env.ADMIN_SEED_PHONE || '+251911000000';
...
async function main() {
    ...
    try {
        ...
        const [user] = await sql`
            ...
            VALUES ('QalNet', 'Administrator', ${ADMIN_PHONE}, ${ADMIN_EMAIL}, ${passwordHash}, 'admin', TRUE)
