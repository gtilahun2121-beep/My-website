      ...
      >
        ...
        <div className="flex justify-between items-start mb-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-black text-[#314fa0]">{equb.name}</h2>
        ...
        <div className="space-y-3">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="w-full py-3 bg-gradient-to-r from-[#314fa0] to-[#d4af37] text-white font-black rounded-full hover:shadow-lg transition-all"
          >
            ✍️ Join This Equb
          </motion.button>
          <motion.button
