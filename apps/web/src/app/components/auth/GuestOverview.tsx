    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          className="space-y-3"
        >
          <h3 className="font-black text-[#00d9ff] text-lg">🏢 Available Equb Groups ({displayedEqubs.length})</h3>
        ...
        >
          <div className="bg-[#001f3f] text-[#00d9ff] rounded-lg p-4 text-center">
          ...
          >
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-black text-[#00d9ff]">{selectedEqub.name}</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              <div className="bg-[#001f3f]/10 rounded-lg p-4">
                ...
                <p className="text-xl sm:text-2xl font-black text-[#00d9ff] break-all">ETB {selectedEqub.monthlyPayment.toLocaleString()}</p>
              </div>
              <div className="bg-[#001f3f]/20 rounded-lg p-4">
                <p className="text-xs text-gray-600 mb-1">Expected Return</p>
                <p className="text-xl sm:text-2xl font-black text-[#00d9ff] break-all">ETB {selectedEqub.expectedReturn.toLocaleString()}</p>
              </div>
            ...
            <div className="bg-[#f5f3f0] border-2 border-[#001f3f] rounded-lg p-4 mb-6">
              <h3 className="font-black text-[#00d9ff] mb-2">⏰ Payout Frequency</h3>
              <p className="text-sm font-bold text-[#00d9ff]">{selectedEqub.payoutFrequency}</p>
            </div>

            <div className="bg-[#f5f3f0] border-2 border-[#001f3f] rounded-lg p-4 mb-6">
              <h3 className="font-black text-[#00d9ff] mb-2">📅 Payment Cycle</h3>
              <p className="text-lg font-black text-[#00d9ff] mb-1">{selectedEqub.paymentCycle.duration} Months</p>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="w-full py-3 bg-gradient-to-r from-[#001f3f] to-[#001f3f] text-[#00d9ff] font-black rounded-full hover:shadow-lg transition-all mb-3"
            >
              ✍️ Join This Equb
            </motion.button>
