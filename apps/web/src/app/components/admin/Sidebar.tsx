...
const ADMIN_NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Payments', disabled: true, icon: icon('M2 8a1 1 0 0 1 1-1h18a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1Zm4 3h.01M6 12h.01M10 11h.01') },
      { label: 'Transactions', disabled: true, icon: icon('M3 17l6-6 4 4 7-7m0 0v5m0-5h-5') },
      { label: 'Wallets', disabled: true, icon: icon('M6 4h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Zm3 2v12m6-6h4') },
      { label: 'Equbs', disabled: true, icon: icon('M4 21v-9m5 9v-7m5 7V4m5 17V10') },
    ],
  },
  {
    heading: 'Operations',
    items: [
      { label: 'Reports', disabled: true, icon: icon('M5 20V10m7 10V4m7 16v-7') },
      { label: 'Analytics', disabled: true, icon: icon('M12 3v3m6.4 2.6-2.1 2.1M21 12h-3M15.6 12H12') },
      ...
      { label: 'System Logs', disabled: true, icon: icon('M4 5h16v14H4V5Zm4 4h8m-8 4h8') },
    ],
  },
];
