    ...
    >
      ...
      <motion.div variants={itemVariants}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-gradient-to-br from-accent-50 to-accent-100 rounded-2xl p-4 border-2 border-accent-200">
            <p className="text-xs text-accent-600 font-bold mb-2">Contribution Commitment</p>
            <h4 className="text-3xl font-black text-accent-700">
          ...
          <div className="space-y-2">
            {pastPayouts.map((payout) => (
              <motion.div
                key={payout.id}
                whileHover={{ x: 4 }}
                className="bg-white border-l-4 border-brand-500 rounded-lg p-4 hover:shadow-md transition-all"
              >
