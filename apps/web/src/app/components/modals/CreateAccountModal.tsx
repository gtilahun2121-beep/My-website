    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-[#314fa0] to-[#d4af37] px-8 py-6 flex justify-between items-center rounded-t-2xl">
              <div>
              ...
              {step === 'account' ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full text-center text-sm text-gray-600 hover:text-[#314fa0] font-semibold"
                  >
                    ← {lang === 'en' ? 'Back' : 'ተመለስ'}
                  </button>
                </>
